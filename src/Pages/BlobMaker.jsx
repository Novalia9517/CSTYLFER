...
const BlobMaker = () => {
  ...
  const [blob, setBlob] = useState(
    `${border1}% ${100 - border1}% ${
      100 - border3
    }% ${border3}% / ${border4}%  ${border2}% ${100 - border2}% ${
      100 - border4
    }%`
  );
  ...
  const blobing = () => {
    let radius = `${border1}% ${100 - border1}% ${
      100 - border3
    }% ${border3}% / ${border4}%  ${border2}% ${100 - border2}% ${
      100 - border4
    }%`;
        ...
        <GridItem xs={12} md={12} lg={6} h="full">
          ...
          >
            <CustomSlider
              ...
              max={100}
              value={border1}
              title={"Border Radius 1"}
              change={(e) => onBlob(setBorder1, e)}
            />
            <CustomSlider
              min={20}
              max={100}
              ...
              change={(e) => onBlob(setBorder2, e)}
            />
            <CustomSlider
              min={20}
              max={100}
              value={border3}
              title={"Border Radius 3"}
              change={(e) => onBlob(setBorder3, e)}
            />
            <CustomSlider
              min={20}
              max={100}
        ...
        <Box bg="gray.800" h={"full"} px={5} py={3} mt={3}>
          ...
          <Box display={"flex"} flexDirection={"column"}>
            ...
            <Code bg="gray.800" color="blue.300" fontSize={"11px"} ml={3}>
              width : 300px; /*custom your own width*/ <br />
              height : 230px; /*custom your own height*/ <br />
