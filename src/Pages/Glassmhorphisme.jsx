    ...
    <Layout>
      ...
      >
        <Box
          ...
          color={"white"}
        >
          <Text fontSize={{ md: "xl", sm: "xs" }} fontWeight="bold">
            Hi, There
          </Text>
          <Text fontSize={{ md: "xl", sm: "xs" }} fontWeight="bold">
            This is Glassmhorphisme
          </Text>
        </Box>
        <Box
          w={"200px"}
        ...
        <Box
          ...
          h="200px"
          w="200px"
          bgGradient="linear(to-r, purple.200, blue.400)"
          borderRadius="50%"
          zIndex={"-10"}
        />
        <Box
        ...
        <Box
          ...
          h="200px"
          w="200px"
          bgGradient="linear(to-l, purple.300, gray.400)"
          borderRadius="50%"
          zIndex={"-10"}
        />
      </Flex>
      <Grid gap={4} mt="3" height={"full"} display={"flex"} flexWrap={"wrap"}>
        <Box
          w={{ md: "50%", base: "full" }}
          display="flex"
          flexDirection={"column"}
          ...
          <Box bg="gray.800" h={"full"} px={5} py={3}>
            ...
            <Box display={"flex"} flexDirection={"column"}>
              ...
              <Code ml={5} bg="gray.800" color="blue.300" fontSize={"11px"}>
                ...
                height : 300px; /*custom your own height*/
                <br />
                background: rgba( {red}, {green}, {blue}, {transparancy} );{" "}
                <br />
